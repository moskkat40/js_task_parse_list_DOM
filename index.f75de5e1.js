...
function sortList(list) {
    return list.sort((a, b)=>convertToNumber(b.dataset.salary) - convertToNumber(a.dataset.salary));
}
...
function addElements() {
    for(let i = 0; i < sortListNew.length; i++)holeList.appendChild(sortListNew[i]);
}
